...
export default function KineticGrid({
  ...
  children?: ReactNode;
  className?: string;
  globalColor?: "default" | "monochrome" | "shakti" | "light";
}) {
  ...
  const draw = useCallback(
    (now: number) => {
      ...
      const themeConfig = {
        ...
        shakti: {
          bg: "#FAFAF9",
          dotColor: "rgba(225,29,72,0.05)",
          lineBase: { r: 225, g: 29, b: 72, a: 0.08 },
          lineActive: { r: 225, g: 29, b: 72, a: 0.85 },
      ...
      const theme = themeConfig[globalColor ?? "shakti"] || themeConfig.shakti;
